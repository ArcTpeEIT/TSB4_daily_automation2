#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Case7 Reset Router+Boosters onboarding test."""
import argparse
import os
import sys
...
def parse_args():
    parser = argparse.ArgumentParser(description="Case7 Reset Router+Boosters onboarding test")
...
def apply_args(args):
    ...
    if args.reset_init_wait is not None:
        cfg.CASE7_ETH_ONBOARDING_INIT_WAIT_TIME = args.reset_init_wait
        cfg.CASE7_WIFI_ONBOARDING_INIT_WAIT_TIME = args.reset_init_wait
    else:
...
if __name__ == "__main__":
    cfg.TEST_CASE_NAME = "case7_Reset Router+Boosters Onboarding"
    args = parse_args()
    apply_args(args)
    init_log_filenames()
    ...
    try:
        ok = run_gui_action_case(
            ...
            cfg.CASE7_ETH_ONBOARDING_INIT_WAIT_TIME,

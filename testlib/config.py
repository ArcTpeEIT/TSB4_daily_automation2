...
CASE3_ETH_ONBOARDING_INIT_WAIT_TIME  = 160
CASE3_WIFI_ONBOARDING_INIT_WAIT_TIME = 190
...
CASE4_ETH_ONBOARDING_INIT_WAIT_TIME  = 130
CASE4_WIFI_ONBOARDING_INIT_WAIT_TIME = 180  # 
...
# Serial reboot confirmation (method 2): watch log file for boot keywords after SSH offline
REBOOT_SERIAL_VERIFY_TIMEOUT        = 120  # Max wait for serial boot keywords after SSH offline (s)
REBOOT_SERIAL_VERIFY_POLL_INTERVAL  = 2    # Log file poll interval during serial verify (s)
REBOOT_SERIAL_KEYWORDS              = [    # Any match = reboot confirmed
    "Restarting system",
    "BusyBox v",
